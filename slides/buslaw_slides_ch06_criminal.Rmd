...
## Introduction {data-background=masaaki-komori-1hUsp3zi0rA-unsplash.jpg data-background-size=cover}
...
## Civil versus criminal law {data-background=masaaki-komori-1hUsp3zi0rA-unsplash.jpg data-background-size=cover}

- _Who_ sues?
- _Why_ do they sue?
- _What_  is the burden to prove their case?
- What are the possible _penalties_?

## Elements of a crime {data-background=masaaki-komori-1hUsp3zi0rA-unsplash.jpg data-background-size=cover}
...
## The incident report ... {data-background=masaaki-komori-1hUsp3zi0rA-unsplash.jpg data-background-size=cover}

<center>
<img src="alligator1.jpg" height="430px">
</center>

## What is a deadly weapon? {data-background=masaaki-komori-1hUsp3zi0rA-unsplash.jpg data-background-size=cover}
...
## How have courts interpreted this? {data-background=masaaki-komori-1hUsp3zi0rA-unsplash.jpg data-background-size=cover}
...
## Types of crimes: examples {data-background=masaaki-komori-1hUsp3zi0rA-unsplash.jpg data-background-size=cover}
...
## Criminal procedure: Applied constitutional law {data-background=masaaki-komori-1hUsp3zi0rA-unsplash.jpg data-background-size=cover}
...
## Exceptions to the warrant requirement: cars {data-background=masaaki-komori-1hUsp3zi0rA-unsplash.jpg data-background-size=cover}
...
## Checkpoints {data-background=masaaki-komori-1hUsp3zi0rA-unsplash.jpg data-background-size=cover}
...
## Exceptions to the Warrant Requirement {data-background=masaaki-komori-1hUsp3zi0rA-unsplash.jpg data-background-size=cover}
...
## The Exclusionary Rule {data-background=masaaki-komori-1hUsp3zi0rA-unsplash.jpg data-background-size=cover}
...
## Miranda Rights {data-background=masaaki-komori-1hUsp3zi0rA-unsplash.jpg data-background-size=cover}
...
## Qualified immunity {data-background=masaaki-komori-1hUsp3zi0rA-unsplash.jpg data-background-size=cover}
