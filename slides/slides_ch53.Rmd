...
- <em>Seek expectation damages</em>
	...
	+ E.g., if A contracts to sell B a marker for $1, and then A breaches, if B finds a marker from an alternative source for $1.50, the damages are $0.50. This puts B in the same position as if A had fulfilled the contract.
...
- These are enforceable, so long as they are reasonable.
	+ E.g., no million dollar liquidated damages clauses for sale of a marker, as that would essentially be creating specific performance.
