...
## Ethics is <em>not</em> the law {data-background=background_white_snow.jpg data-background-size=cover}
...
## Would it be easier to just follow a set of rules?  {data-background=background_white_snow.jpg data-background-size=cover}
- This is <em>deontology</em>
...
- But this has it's own set of of problems:
    ...
    - What if the rules lead to strange results?
        - E.g., is choosing not have children unethical by the categorical imperative?
- Should we consider <em>"virtue"</em> alone?
    - Which virtues?
...
## Stakeholder analysis  {data-background=background_white_snow.jpg data-background-size=cover}
...
## Corporate Social Responsibility  {data-background=background_white_snow.jpg data-background-size=cover}
Corporate Social Responsibility (CSR) says companies should consider the needs of all <em>stakeholders</em> (employees, community, customers, environment, etc), rather than just attempting to maximize shareholder profit
...
## Practice  {data-background=background_white_snow.jpg data-background-size=cover}
