...
author: "Business Law: An Introduction, ch. 09"
date: "v. 1.2.0"
output: 
...
## Warranty disclaimers {data-background=blackdunes.png data-background-size=cover}
...
For example, the implied warranty of merchantability can be disclaimed by selling goods <em>"as is"</em>.
